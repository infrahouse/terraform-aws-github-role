...
TEST_ROLE ?= arn:aws:iam::303467602807:role/github-role-tester
...
.PHONY: docs
docs: ## Regenerate the terraform-docs section in README.md
	terraform-docs .
...
clean:  ## Remove various artifacts
	...
	find . -path ./.git -prune -o -name '.terraform' -exec rm -fr {} +
	find . -path ./.git -prune -o -name '.terraform.lock.hcl' -exec rm {} +
	find test_data -name 'terraform.tfstate*' -exec rm {} +
